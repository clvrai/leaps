...
#        'collate_fn': lambda x: x,                 # collate_fn to get minibatch as list instead of tensor
    ...
    'env_task': 'cleanHouse',                          # ['program', 'stairClimber', 'placeSetter', 'topOff', 'chainSmoker', 'shelfStocker', 'maze']
    ...
    'height': 14,                                    # height of karel environment
    'width': 22,                                     # width of karel environment
